...
public class VehicaleData {
    ...
    public VehicaleData(String key) {
        this.key = key;
    }
    ...
    public VehicaleData(String category, String vehicale_Medel, String vehicale_Number, String RCBookNumber, String available_Seats, String vehicale_Location, String itemImage, String ownername, String contact) {
